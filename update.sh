...
curl https://raw.githubusercontent.com/asins/vim-dict/master/dict/ruby.dic > $DICT_DIR/ruby.dict
curl https://raw.githubusercontent.com/asins/vim-dict/master/dict/php.dic > $DICT_DIR/php.dict
